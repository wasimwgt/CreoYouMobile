...
(function(factory) {
    ...
    defaults = {
        ...
        onlyCountries: [],
        // the countries at the top of the list. defaults to united states and united kingdom //"in", "us"
        preferredCountries: [],
   ...
   ********************/
        ...
        _appendListItems: function(countries, className) {
            ...
            for (var i = 0; i < countries.length; i++) {
                var c = countries[i];
                // open the list item
                tmp += "<li value='" + c.iso2 +"' class='country " + className + "' data-dial-code='" + c.dialCode + "' data-country-code='" + c.iso2 + "'>";
                // add the flag
