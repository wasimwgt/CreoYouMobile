    ...
    $scope.tracks = [
        {
            ...
            url: '/android_asset/www/audio/Moh Moh Ke Dhaage (Female) - DownloadMing.SE.mp3', 
            artist: 'The Police',
            title: 'Moh Moh Ke Dhaage (Female) - DownloadMing.SE',
            art: 'http://static.mahamp3.com/assets/171/500/Dum%20Laga%20Ke%20Haisha.jpg'
        },
        //{
...
.controller('countryCtrl', function($scope, $ionicConfig,$rootScope) {
  $scope.name="test";
...
/*.controller('VideoController',  function videoController($scope, $timeout, video) {
...
// Triggered on a button click, or some other target
  ...
  var myPopup = $ionicPopup.show({ 
    ...
    template:'<input type="text" ng-model="country.dial_code" class="country_code"><select ng-model="country" ng-init="country=countries[0]" ng-options="country.name for country in countries" class="reg_select"></select><input type="tel" class="mobile_no" placeholder="Mobile Number">',
